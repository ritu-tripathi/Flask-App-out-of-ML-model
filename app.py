...
def predict():
    if request.method == 'POST':
       ...
       if study_hours<0 or study_hours>24:
            ...
            return render_template('index.html', prediction_text='If you are studying for {} hours a day , you will score around {} percentage marks! keep studying!!').format(int(study_hours),prediction) 
